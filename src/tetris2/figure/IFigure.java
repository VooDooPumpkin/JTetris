...
extends Figure {
    public IFigure(int xCenter, int yCenter, int figureId) {
        super();
        this.color = new Color(14, 206, 206);
        this.figureId = figureId;
        this.cells.add(new Cell(new Point(xCenter - 2, yCenter), this.color, this.figureId));
